...
RUN microdnf install -y \
	...
	git \
	vim && \
	curl -fOL https://github.com/coder/code-server/releases/download/v4.101.2/code-server-4.101.2-arm64.rpm && \
    rpm -i code-server-4.101.2-arm64.rpm && \
    rm code-server-4.101.2-arm64.rpm && \
	microdnf clean all
